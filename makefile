all: delete
	ocamlc -c abstractSyntax.ml operationalTypes.ml printStuff.ml staticSemantics.ml operationalSemantics.ml 
	@echo "### Lexer:"
	...
	ocamlc -o main abstractSyntax.cmo operationalTypes.cmo printStuff.cmo staticSemantics.cmo operationalSemantics.cmo miniOO_LEX.cmo miniOO_MENHIR.cmo main.cmo
